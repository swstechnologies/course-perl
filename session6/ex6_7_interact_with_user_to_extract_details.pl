...
# TODO: Bring back function here from ex6_6_dump_sorted_power_data.pl
...
# Implement the function to interact with the user
# This function will interact with the user, ask for input data,
# retrieve back correspondings cells data and then display the data
sub interact_with_user($) {
    # This function will interact with the user and display the data
    my ($log_data) = @_;
    while (1) {
        my $process, $voltage, $temperature, $cell;
        # Get all relevant parameters from the user
...
sub get_cell_data {
    ...
    # Find and return relevant data from the log_data structure
    return undef;
}
